...
struct PolygonalMesh
{
    ...
    std::vector<vector<int>> Cell2DsVertices = {}; ///< Cell2D Vertices indices, size 1 x NumberCell2DVertices[NumberCell2D]
	std::vector<int> Cell2DsNumEdges = {}; // number of edges for each polygon, useful in order to mesure areas//
    std::vector<vector<int>> Cell2DsEdges = {}; ///< Cell2D Cell1D indices, size 1 x NumberCell2DEdges[NumberCell2D]
